...
class CreateTecolePaiementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tecole_paiements', function (Blueprint $table) {
            $table->id();
            $table->foreignId('RefInscription')->constrained('tecole_inscriptions')->restrictOnUpdate()->restrictOnDelete();
    ...
    {
        Schema::dropIfExists('tecole_paiements');
    }
}
